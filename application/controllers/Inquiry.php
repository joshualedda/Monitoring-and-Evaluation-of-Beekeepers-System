...
class Inquiry extends Admin_Controller 
{
	public function __construct()
	{
		...
		$this->data['page_title'] = $this->lang->line('Inquiry');
    ...
    public function fetchInquiryBeekeeper($id)
    {
        $result = array('data' => array());

        $data = $this->model_inquiry->getInquiryBeekeeper($id);   
	...
	public function create()
	{
		...
		$this->form_validation->set_rules('inquiry_type', $this->lang->line('Inquiry Type'), 'trim|required');
		$this->form_validation->set_rules('support_type', $this->lang->line('Support Type'), 'trim|required');
	...
	public function update($id)
	{
		...
		if($id) {
			...
			$this->form_validation->set_rules('edit_inquiry_type', $this->lang->line('Inquiry Type'), 'trim|required');
			$this->form_validation->set_rules('edit_support_type', $this->lang->line('Support Type'), 'trim|required');
			$this->form_validation->set_error_delimiters('<p class="text-danger">','</p>');
