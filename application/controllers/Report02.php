...
{	 
	public function __construct()
	{
		...
		$this->data['page_title'] = $this->lang->line('Report02');
	...
	public function REP02() {	
		...
		$this->table->set_heading('<th width="10%" height="28"><strong>'.$this->lang->line('Colony No').'</strong></th>', 
			                      '<th width="18%" height="28"><strong>'.$this->lang->line('Beekeeper Name').'</strong></th>',
			                      '<th width="15%" height="28"><strong>'.$this->lang->line('Location').'</strong></th>',
			                      '<th width="8%" height="28" align="right"><strong>'.$this->lang->line('Area Size').'</strong></th>',
			                  	  '<th width="15%" height="28"><strong>'.$this->lang->line('Province').'</strong></th>',
			                  	  '<th width="10%" height="28"><strong>'.$this->lang->line('Bee Type').'</strong></th>',
		...
		if ($REP02 == null) {
			...
			foreach ($REP02 as $rs):
				...
				$cell1 = array('data' => $rs->colony_no, 'width' => '10%');
				$cell2 = array('data' => $rs->beekeeper_name, 'width' => '18%');
				$cell3 = array('data' => $rs->location, 'width' => '15%');
				$cell4 = array('data' => $rs->area_size, 'width' => '8%', 'align' => 'right');
				$cell5 = array('data' => $rs->province_name, 'width' => '15%');
				$cell6 = array('data' => $rs->bee_type_code, 'width' => '10%');
				$cell7 = array('data' => $rs->date_begin, 'width' => '8%');
				$cell8 = array('data' => $rs->date_end, 'width' => '8%');
				$cell9 = array('data' => $rs->phase_name, 'width' => '8%');
