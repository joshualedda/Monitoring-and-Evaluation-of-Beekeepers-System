...
{	 
	public function __construct()
	{
		...
		$this->data['page_title'] = $this->lang->line('Report04');;
	...
	public function REP04() {	
		...
		$this->table->set_heading('<th width="7%" height="28"align="center"><strong>'.$this->lang->line('Register Id').'</strong></th>', 
			  '<th width="15%" height="28" align="left"><strong>'.$this->lang->line('Beekeeper Name').'</strong></th>',
			  '<th width="10%" height="28" height="28" align="left"><strong>'.$this->lang->line('Support Type').'</strong></th>',
			  '<th width="8%" height="28" align="left"><strong>'.$this->lang->line('Inquiry Type').'</strong></th>',
          	  '<th width="20%" height="28" align="left"><strong>'.$this->lang->line('Request').'</strong></th>',
          	  '<th width="20%" height="28" align="left"><strong>'.$this->lang->line('Feedback').'</strong></th>',
          	  '<th width="10%" height="28" align="left"><strong>'.$this->lang->line('Answered by').'</strong></th>',
          	  '<th width="10%" height="28" align="left"><strong>'.$this->lang->line('Date').'</strong></th>'
          	   );
		...
		if ($REP04 == null) {
			...
			foreach ($REP04 as $rs):
				$cell1 = array('data' => $rs->beekeeper_register_id, 'width' => '7%');
				$cell2 = array('data' => $rs->beekeeper_name, 'width' => '15%');
