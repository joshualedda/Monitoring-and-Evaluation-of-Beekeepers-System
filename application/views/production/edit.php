<div id="main">
  <div class="main-container">
    <div class="page-header-card">
      <div>
        <h4><i class="ph ph-pencil-simple me-2 text-primary"></i><?php echo $this->lang->line('Edit Production'); ?></h4>
      </div>
        ...
        <div class="col-md-12 col-xs-12">
          ...
          <div class="card border-0 shadow-sm rounded-4 mb-4">
            <div class="card-header bg-transparent border-bottom border-light pt-4 px-4 pb-3">
                  <h5 class="fw-bold mb-0 text-dark"><i class="ph ph-pencil-line me-2 text-primary"></i>Edit Production Record</h5>
              </div>
            <form role="form" action="<?php echo base_url('production/update/'.$production_data['id']) ?>" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control select_group" id="colony_id" name="colony_id" required>
                          <?php foreach ($colonies as $k => $v): ?>
                            <option value="<?php echo $v['id'] ?>" <?php if($production_data['colony_id'] == $v['id']) { echo "selected='selected'"; } ?>><?php echo 'Colony ' . $v['id'] . ' (' . ($v['location'] ?? 'Unknown location') . ')'; ?></option>
                          <?php endforeach ?>
                        </select>
                      </div>
                    </div>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control select_group" id="product_id" name="product_id" required>
                          <?php foreach ($products as $k => $v): ?>
                            <option value="<?php echo $v['id'] ?>" <?php if($production_data['product_id'] == $v['id']) { echo "selected='selected'"; } ?>><?php echo $v['name'] ?></option>
                          <?php endforeach ?>
                        </select>
                      </div>
                    </div>
                  ...
                  <div class="row g-4 mb-4">
                    <div class="col-md-4 col-xs-4">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="total_production" name="total_production" autocomplete="off" value="<?php echo set_value('total_production', $production_data['total_production']); ?>" />
                      </div>
                    </div>
                    ...
                    <div class="col-md-4 col-xs-4">
                      <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="production_date" name="production_date" autocomplete="off" value="<?php echo set_value('production_date', $production_data['production_date']); ?>" />
                      </div>
                    </div>
                    ...
                    <div class="col-md-4 col-xs-4">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="year" name="year" autocomplete="off" value="<?php echo set_value('year', $production_data['year']); ?>" required />
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row g-4 mb-4">
                    <div class="col-md-4 col-xs-4">
                      <div class="form-group">
                        ...
                        <input type="number" step="0.01" class="form-control" id="cost" name="cost" autocomplete="off" value="<?php echo set_value('cost', $production_data['cost']); ?>" />
                      </div>
                    </div>
                    ...
                    <div class="col-md-4 col-xs-4">
                      <div class="form-group">
                        ...
                        <input type="number" step="0.01" class="form-control" id="gross_income" name="gross_income" autocomplete="off" value="<?php echo set_value('gross_income', $production_data['gross_income']); ?>" />
                      </div>
                    </div>
                    ...
                    <div class="col-md-4 col-xs-4">
                      <div class="form-group">
                        ...
                        <input type="number" step="0.01" class="form-control" id="net_income" name="net_income" autocomplete="off" value="<?php echo set_value('net_income', $production_data['net_income']); ?>" />
                      </div>
                    </div>
                  </div>
