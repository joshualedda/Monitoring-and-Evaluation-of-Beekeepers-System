<div id="main">
  <div class="main-container">
    <div class="page-header-card">
      <div>
        <h4><i class="ph ph-factory me-2 text-primary"></i><?php echo $this->lang->line('Production'); ?></h4>
        <p>Manage production records.</p>
      </div>
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0 small">
          <li class="breadcrumb-item"><a href="<?php echo base_url('dashboard') ?>" class="text-decoration-none">Home</a></li>
          <li class="breadcrumb-item active"><?php echo $this->lang->line('Production'); ?></li>
        </ol>
      </nav>
    </div>
      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="dt-card">
          <div class="dt-card-header">
            <h5 class="mb-0">All Production Records</h5>
            <?php if(in_array('createProduction', $user_permission)): ?>
              <a href="<?php echo base_url('production/create') ?>" class="btn-dt-add">
                <i class="ph ph-plus mb-1"></i> <?php echo $this->lang->line('Add Production'); ?>
              </a>
            <?php endif; ?>
          </div>
          <div class="dt-card-body p-0">
            <div class="datatable-wrapper">
              <table id="manageTable" class="table align-middle mb-0">
                <thead>
                <tr>
                  <th><?php echo $this->lang->line('Colony'); ?></th>
                  <th><?php echo $this->lang->line('Product'); ?></th>
                  <th><?php echo $this->lang->line('Total Production'); ?></th>
    ...
    <div class="modal-content border-0 shadow rounded-4">
      <div class="modal-header border-bottom-0 pb-0 pt-4 px-4">
        <h4 class="modal-title fw-bold text-danger d-flex align-items-center">
          ...
          <?php echo $this->lang->line('Delete Production Record'); ?>
        </h4>
      ...
      <form role="form" action="<?php echo base_url('production/remove') ?>" method="post" id="removeForm">
        <div class="modal-body px-4 py-4">
          <p class="text-secondary mb-3"><?php echo $this->lang->line('All the information about this production record will be deleted.'); ?></p>
