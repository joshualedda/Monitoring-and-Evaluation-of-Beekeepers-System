<div id="main">
  <div class="main-container">
    <div class="page-header-card mb-4">
      <div>
        <h4><i class="ph ph-plus-circle me-2 text-primary"></i>Add Satellite Center</h4>
        <p>Register a new regional satellite center.</p>
      </div>
      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <div class="card border-0 shadow-sm rounded-4 bg-white overflow-hidden">
            <form role="form" action="<?php echo base_url('satellite_centers/create') ?>" method="post">
              <div class="card-body p-4">
                <div class="row g-4">
                  <div class="col-md-12">
                    <label for="satellite_name" class="form-label fw-bold">Satellite Center Name <font color="red">*</font></label>
                    <input type="text" class="form-control rounded-3" id="satellite_name" name="satellite_name" value="<?php echo set_value('satellite_name'); ?>" placeholder="Enter name of the center" autocomplete="off"/>
                  </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text" class="form-control rounded-3" id="coordinate" name="coordinate" value="<?php echo set_value('coordinate'); ?>" placeholder="Example: 16.612, 120.316" autocomplete="off"/>
                  ...
                  <div class="col-md-12">
                    ...
                    <textarea class="form-control rounded-3" id="map" name="map" rows="2" placeholder="Paste the full Google Maps URL here..."><?php echo set_value('map'); ?></textarea>
                  </div>
                </div>
              </div>
              ...
              <div class="card-footer bg-light p-4 border-0 d-flex justify-content-end gap-2">
                ...
                <button type="submit" class="btn btn-primary px-4 rounded-3">Save Center</button>
              </div>
            </form>
          </div>
        </div>
