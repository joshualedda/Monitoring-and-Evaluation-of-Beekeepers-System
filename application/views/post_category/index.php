<div id="main">
  <div class="main-container">
    ...
    <div class="page-header-card">
      <div>
        <h4><i class="ph ph-newspaper me-2 text-primary"></i><?php echo $this->lang->line('Category'); ?></h4>
        <p>Manage categories for news, announcements, and posts.</p>
      </div>
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0 small">
          <li class="breadcrumb-item"><a href="<?php echo base_url('dashboard') ?>" class="text-decoration-none">Home</a></li>
          <li class="breadcrumb-item active"><?php echo $this->lang->line('Category'); ?></li>
        </ol>
      </nav>
    </div>
        ...
        <div class="dt-card">
          <div class="dt-card-header">
            ...
            <div class="d-flex gap-2">
              <?php if(in_array('viewPostCategory', $user_permission)): ?>
                <a href="<?php echo base_url('report06/report06/post_category'); ?>" target="_blank" class="btn btn-light border d-flex align-items-center">
                  <i class="ph ph-printer me-2 fs-5"></i> Print
                </a>
              <?php endif; ?>
              <?php if(in_array('createPostCategory', $user_permission)): ?>
            ...
            <div class="datatable-wrapper">
              <table id="manageTable" class="table align-middle mb-0">
                ...
                <tr>                
                  ...
                  <?php if(in_array('updatePostCategory', $user_permission) || in_array('deletePostCategory', $user_permission)): ?>
...
<div class="modal fade" tabindex="-1" role="dialog" id="addModal">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content border-0 shadow rounded-4">
      ...
      <form role="form" action="<?php echo base_url('post_category/create') ?>" method="post" id="createForm">
        <div class="modal-body px-4 py-4">
          <div class="mb-4">
            <label for="post_category_name" class="form-label fw-semibold text-secondary small text-uppercase l-spacing-1"><?php echo $this->lang->line('Name'); ?><font color="red"> *</font></label>
            <input type="text" class="form-control rounded-3" id="post_category_name" name="post_category_name" autocomplete="off" placeholder="Enter category name">
          </div>
...
<?php if(in_array('updatePostCategory', $user_permission)): ?>
<!-- edit modal -->
<div class="modal fade" tabindex="-1" role="dialog" id="editModal">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content border-0 shadow rounded-4">
      ...
      <form role="form" action="<?php echo base_url('post_category/update') ?>" method="post" id="updateForm">
        <div class="modal-body px-4 py-4">
          <div id="messages_edit"></div>

          <div class="mb-4">
            <label for="edit_post_category_name" class="form-label fw-semibold text-secondary small text-uppercase l-spacing-1"><?php echo $this->lang->line('Name'); ?><font color="red"> *</font></label>
            <input type="text" class="form-control rounded-3" id="edit_post_category_name" name="edit_post_category_name" autocomplete="off" placeholder="Enter category name">
          </div>
...
<?php if(in_array('deletePostCategory', $user_permission)): ?>
<div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content border-0 shadow rounded-4">
      ...
      <form role="form" action="<?php echo base_url('post_category/remove') ?>" method="post" id="removeForm">
        <div class="modal-body px-4 py-4">
...
$(document).ready(function() {
  $("#post_categoryNav").addClass('active');

  // initialize the datatable 
  manageTable = $('#manageTable').DataTable({
    'ajax': base_url + 'post_category/fetchPost_categoryData',
...
{ 
  $.ajax({
    url: base_url + 'post_category/fetchPost_categoryDataById/'+id,
    type: 'post',
    dataType: 'json',
    success:function(response) {
      $("#updateForm")[0].reset();
      $(".text-danger").remove();
      $("#edit_post_category_name").val(response.name);
