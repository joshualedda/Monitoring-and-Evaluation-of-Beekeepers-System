<div id="main">
  <div class="main-container">
    ...
    <div class="page-header-card">
      <div>
        <h4><i class="ph ph-buildings me-2 text-primary"></i><?php echo $this->lang->line('Lgu'); ?></h4>
        <p>Manage Local Government Units (Municipalities/Cities) and their zip codes.</p>
      </div>
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0 small">
          ...
          <li class="breadcrumb-item active small text-primary fw-medium"><?php echo $this->lang->line('Lgu'); ?></li>
        </ol>
      </nav>
    </div>
      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="dt-card">
          <div class="dt-card-header">
            <h5 class="mb-0">All LGUs</h5>
            <div class="d-flex gap-2">
              <?php if(in_array('viewLgu', $user_permission)): ?>
                <a href="<?php echo base_url('report06/report06/lgu') ?>" target="_blank" class="btn btn-light border d-flex align-items-center" title="Print List">
              ...
              <?php if(in_array('createLgu', $user_permission)): ?>
                <button class="btn-dt-add" data-bs-toggle="modal" data-bs-target="#addModal" onclick="createFunc()">
                   <i class="ph ph-plus mb-1"></i> <?php echo $this->lang->line('Add Lgu'); ?>
                </button>
              <?php endif; ?>
            </div>
          </div>
            ...
            <div class="datatable-wrapper">
              <table id="manageTable" class="table align-middle mb-0">
                ...
                <tr>             
                  ...
                  <th><?php echo $this->lang->line('Zip Code'); ?></th>
                  <th width="15%"><?php echo $this->lang->line('Active'); ?></th>
                  <?php if(in_array('updateLgu', $user_permission) || in_array('deleteLgu', $user_permission)): ?>
    ...
    <div class="modal-content border-0 shadow rounded-4">
      <div class="modal-header border-bottom-0 pb-0 pt-4 px-4">
        <h4 class="modal-title fw-bold text-dark l-spacing-1 d-flex align-items-center">
          ...
          <?php echo $this->lang->line('Add Lgu'); ?>
        </h4>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>

      <form role="form" action="<?php echo base_url('lgu/create') ?>" method="post" id="createForm">
        <div class="modal-body px-4 py-4">
          <div class="mb-3">
              <label class="form-label fw-semibold text-secondary small text-uppercase l-spacing-1"><?php echo $this->lang->line('Province'); ?><font color="red"> *</font></label>
              <select name="province" id="province" class="form-control select2" style="width: 100%;">
                <option value="" hidden selected>Select Province</option>
              </select>
          </div>

          <div class="row g-3 mb-3">
             <div class="col-md-6">
                <label for="lgu_code" class="form-label fw-semibold text-secondary small text-uppercase l-spacing-1"><?php echo $this->lang->line('Code'); ?></label>
                <input type="text" class="form-control rounded-3" id="lgu_code" name="lgu_code" autocomplete="off" placeholder="Enter code">
             </div>
          ...
          <div class="mb-3">
            <label for="lgu_name" class="form-label fw-semibold text-secondary small text-uppercase l-spacing-1"><?php echo $this->lang->line('Name'); ?><font color="red"> *</font></label>
            <input type="text" class="form-control rounded-3" id="lgu_name" name="lgu_name" autocomplete="off" placeholder="Enter LGU name">
          </div>         
          <div class="mb-0">
            <label for="lgu_name_zipcode" class="form-label fw-semibold text-secondary small text-uppercase l-spacing-1"><?php echo $this->lang->line('Zip Code'); ?><font color="red"> *</font></label>
            <input type="text" class="form-control rounded-3 shadow-sm border-light-subtle" id="lgu_name_zipcode" name="lgu_zipcode" autocomplete="off" placeholder="Enter zip code">
          </div>         
        </div>
...
<?php if(in_array('updateLgu', $user_permission)): ?>
    ...
    <div class="modal-content border-0 shadow rounded-4">
      <div class="modal-header border-bottom-0 pb-0 pt-4 px-4">
        <h4 class="modal-title fw-bold text-dark l-spacing-1 d-flex align-items-center">
          ...
          <?php echo $this->lang->line('Edit Lgu'); ?>
        </h4>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>

      <form role="form" action="<?php echo base_url('lgu/update') ?>" method="post" id="updateForm">
        <div class="modal-body px-4 py-4">
          <div id="messages_edit"></div>

          <div class="mb-3">
              <label class="form-label fw-semibold text-secondary small text-uppercase l-spacing-1"><?php echo $this->lang->line('Province'); ?><font color="red"> *</font></label>
              <select name="edit_lgu_province" id="edit_province" class="form-control select2" style="width: 100%;">
                <option value="" hidden selected>Select Province</option>
              </select>
          </div>
          ...
          <div class="row g-3 mb-3">
             <div class="col-md-6">
                <label for="edit_lgu_code" class="form-label fw-semibold text-secondary small text-uppercase l-spacing-1"><?php echo $this->lang->line('Code'); ?></label>
                <input type="text" class="form-control rounded-3" id="edit_lgu_code" name="edit_lgu_code" autocomplete="off" placeholder="Enter code">
             </div>
          ...
          <div class="mb-3">
            <label for="edit_lgu_name" class="form-label fw-semibold text-secondary small text-uppercase l-spacing-1"><?php echo $this->lang->line('Name'); ?><font color="red"> *</font></label>
            <input type="text" class="form-control rounded-3 shadow-sm border-light-subtle" id="edit_lgu_name" name="edit_lgu_name" autocomplete="off" placeholder="Enter LGU name">
          </div>  
          <div class="mb-0">
            <label for="edit_lgu_zipcode" class="form-label fw-semibold text-secondary small text-uppercase l-spacing-1"><?php echo $this->lang->line('Zip Code'); ?><font color="red"> *</font></label>
            <input type="text" class="form-control rounded-3 shadow-sm border-light-subtle" id="edit_lgu_zipcode" name="edit_lgu_zipcode" autocomplete="off" placeholder="Enter zip code">
          </div> 
        </div>
...
<?php if(in_array('deleteLgu', $user_permission)): ?>
    ...
    <div class="modal-content border-0 shadow rounded-4">
      <div class="modal-header border-bottom-0 pb-0 pt-4 px-4">
        <h4 class="modal-title fw-bold text-danger d-flex align-items-center">
          ...
          <?php echo $this->lang->line('Delete Lgu'); ?>
        </h4>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>

      <form role="form" action="<?php echo base_url('lgu/remove') ?>" method="post" id="removeForm">
        <div class="modal-body px-4 py-4">
...
$(document).ready(function() {
  ...
  //---> creation of the drop-down list province
    var fetchProvinces = function(target) {
        var $select = $(target);
        $.ajax({
            url: base_url+'province/fetchActiveProvince',
            dataType: "JSON", 
            success: function (data) {
                //iterate over the data and append a select option
                $.each(data, function (key, val) {
                    $select.append('<option value="' + val.id + '">' + val.name +', '+val.region_name+ '</option>');  
                }); 
            }, 
            error: function () {
    ...
    fetchProvinces('#edit_province');

  $("#lguNav").addClass('active');

  // initialize the datatable 
  manageTable = $('#manageTable').DataTable({
    'ajax': base_url + 'lgu/fetchLguData',
...
{ 
  $.ajax({
    url: base_url + 'lgu/fetchLguDataById/'+id,
    type: 'post',
    dataType: 'json',
    success:function(response) {
      $("#updateForm")[0].reset();
      ...
      $('#edit_province').val(response.province_id).trigger('change');
      $("#edit_lgu_code").val(response.code);
      $("#edit_lgu_name").val(response.name);
      $("#edit_lgu_zipcode").val(response.zip_code);
          ...
          success:function(response) {
            ...
            if(response.success === true) {
              ...
              if(response.messages instanceof Object) {
                $.each(response.messages, function(index, value) {
                  var id = $("#"+index);
                  if(index == 'edit_lgu_province') id = $("#edit_province");
                  id.closest('.mb-3, .form-group').find('.text-danger').remove();
                  id.after(value);
                });
              } else {
