<div id="main">
  <div class="main-container">
    <div class="page-header-card">
      <div>
        <h4><i class="ph ph-map-pin me-2 text-primary"></i><?php echo $this->lang->line('Apiary'); ?></h4>
        <p>Manage apiary locations and topography data.</p>
      </div>
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0 small">
          <li class="breadcrumb-item"><a href="<?php echo base_url('dashboard') ?>" class="text-decoration-none">Home</a></li>
          <li class="breadcrumb-item active"><?php echo $this->lang->line('Apiary'); ?></li>
        </ol>
      </nav>
    </div>
      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="dt-card">
          <div class="dt-card-header">
            <h5 class="mb-0">All Apiaries</h5>
            <?php if(in_array('createApiary', $user_permission)): ?>
              <a href="<?php echo base_url('apiary/create') ?>" class="btn-dt-add">
                <i class="ph ph-plus mb-1"></i> <?php echo $this->lang->line('Add Apiary'); ?>
              </a>
            <?php endif; ?>
          </div>
          <div class="dt-card-body p-0">
            <div class="datatable-wrapper">
              <table id="manageTable" class="table align-middle mb-0">
                <thead>
                <tr>
                  <th><?php echo $this->lang->line('Apiary Location'); ?></th>
                  <th><?php echo $this->lang->line('Beekeeper Name'); ?></th>
                  <th><?php echo $this->lang->line('Source'); ?></th>
                  <th><?php echo $this->lang->line('Topography'); ?></th>
    ...
    <div class="modal-content border-0 shadow rounded-4">
      <div class="modal-header border-bottom-0 pb-0 pt-4 px-4">
        <h4 class="modal-title fw-bold text-danger d-flex align-items-center">
          ...
          <?php echo $this->lang->line('Delete Apiary'); ?>
        </h4>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>

      <form role="form" action="<?php echo base_url('apiary/remove') ?>" method="post" id="removeForm">
        <div class="modal-body px-4 py-4">
          <p class="text-secondary mb-3"><?php echo $this->lang->line('All the information about the apiary will be deleted.'); ?></p>
          ...
          <p class="text-secondary mb-4"><?php echo $this->lang->line('Change the activity of the apiary (inactive) if you want to keep the information.'); ?></p>
