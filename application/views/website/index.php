  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navMenu">
      <ul class="navbar-nav mx-auto gap-1">
        ...
        <li class="nav-item"><a class="nav-link nav-link-item" href="<?php echo base_url('website/map'); ?>">Apiaries</a></li>
        <li class="nav-item"><a class="nav-link nav-link-item" href="<?php echo base_url('colony/'); ?>">Colonies</a></li>
        <li class="nav-item"><a class="nav-link nav-link-item" href="#">Products</a></li>
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item active">
      <div class="hero-slide hero-slide-1">
        <div class="hero-content container text-white">
          <div class="hero-label"><span>🌿</span> Sustainable Beekeeping</div>
          <h1 class="hero-title">Smart Apiary Management,<br><span class="accent">Sustainably Produced</span> Honey.</h1>
          <p class="hero-subtitle">Monitor colonies, track honey production, and support local beekeepers with data-driven insights across the Philippines.</p>
          <div class="d-flex flex-wrap gap-3">
            <a href="<?php echo base_url('website/map'); ?>" class="btn-hero-primary"><i class="ph ph-map-pin"></i> Explore Apiaries</a>
    ...
    <div class="carousel-item">
      <div class="hero-slide hero-slide-2">
        <div class="hero-content container text-white">
          <div class="hero-label"><span>🍯</span> Honey Harvesting</div>
          <h1 class="hero-title">From Hive to Table,<br><span class="accent">Every Drop Traceable.</span></h1>
          <p class="hero-subtitle">Real-time colony health monitoring ensures the purest, most sustainably harvested honey for our communities.</p>
          <div class="d-flex flex-wrap gap-3">
            <a href="<?php echo base_url('website/map'); ?>" class="btn-hero-primary"><i class="ph ph-map-pin"></i> View Apiary Locations</a>
            <a href="<?php echo base_url('auth/login'); ?>" class="btn-hero-outline"><i class="ph ph-layout"></i> Access Dashboard</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="carousel-item">
      <div class="hero-slide hero-slide-3">
        <div class="hero-content container text-white">
          <div class="hero-label"><span>🐝</span> Colony Intelligence</div>
          <h1 class="hero-title">Empowering Philippine<br><span class="accent">Beekeepers</span> with Data.</h1>
          <p class="hero-subtitle">Digitize your apiary operations, manage colony health, and unlock production insights — all from one platform.</p>
          <div class="d-flex flex-wrap gap-3">
  ...
  <div class="container">
    <div class="row g-4 text-center">
      <div class="col-6 col-md-3">
        <div class="stat-item">
          <div class="stat-num"><?php echo $total_apiary ?? '50+'; ?></div>
          <div class="stat-lbl">Registered Apiaries</div>
        </div>
      </div>
      <div class="col-6 col-md-3">
        <div class="stat-item">
      ...
      <div class="col-6 col-md-3">
        <div class="stat-item">
          <div class="stat-num"><?php echo $total_colony ?? '500+'; ?></div>
          <div class="stat-lbl">Managed Colonies</div>
        </div>
      </div>
      <div class="col-6 col-md-3">
        <div class="stat-item">
          <div class="stat-num">100%</div>
          <div class="stat-lbl">Philippine Sourced</div>
        </div>
      </div>
    </div>
  </div>
...
<section class="why-section honeycomb-bg">
  <div class="container">
    <div class="text-center mb-5 reveal">
      <div class="section-label justify-content-center">Why APIACORE</div>
      <h2 class="section-heading fs-1 mb-3">Smart. Sustainable. Traceable.</h2>
      <p class="section-sub">Everything you need to manage apiaries, support beekeepers, and ensure quality honey production — in one integrated platform.</p>
    </div>
    <div class="row g-4">
      <div class="col-sm-6 col-lg-3 reveal" style="transition-delay:.05s">
        <div class="feature-card">
          <div class="feature-icon" style="background:#fff8e1;">🗺️</div>
          <h4>Apiary Monitoring</h4>
          <p>Track hive locations, environmental conditions, and site performance in real-time with interactive maps.</p>
        </div>
      </div>
      <div class="col-sm-6 col-lg-3 reveal" style="transition-delay:.1s">
        <div class="feature-card">
          <div class="feature-icon" style="background:#e8f5e9;">🐝</div>
          <h4>Colony Management</h4>
          <p>Manage bee colonies, monitor health status, and track productivity metrics across all registered hives.</p>
        </div>
      </div>
      <div class="col-sm-6 col-lg-3 reveal" style="transition-delay:.15s">
        <div class="feature-card">
          ...
          <p>Eco-friendly practices and data insights guide beekeepers toward long-term, responsible honey production.</p>
        </div>
      </div>
      <div class="col-sm-6 col-lg-3 reveal" style="transition-delay:.2s">
        <div class="feature-card">
          <div class="feature-icon" style="background:#fff8e1;">🍯</div>
          <h4>Traceable Honey Supply</h4>
          <p>Full traceability from hive to market — verify origin, quality, and conditions for every honey batch.</p>
        </div>
      </div>
    </div>
  </div>
...
<section class="products-section">
  <div class="container">
    <div class="text-center mb-5 reveal">
      <div class="section-label justify-content-center">Honey Products</div>
      <h2 class="section-heading fs-1 mb-3">Our Harvest</h2>
      <p class="section-sub">Pure, locally sourced honey and bee products from registered apiaries across the Philippines.</p>
    </div>
    <div class="row g-4">
      ...
      <div class="col-sm-6 col-lg-3 reveal" style="transition-delay:.05s">
        <div class="product-card">
          <div class="product-img-wrap">
            <img src="https://images.unsplash.com/photo-1587049352846-4a222e784d38?w=600&q=80&fit=crop" alt="Wild Honey" loading="lazy">
            <span class="product-badge badge-instock">✓ In Stock</span>
          </div>
          <div class="product-body">
            <div class="product-name">Wild Honey</div>
            <div class="product-sub">Forest-foraged, raw & unfiltered</div>
            <a href="#" class="btn-product">Learn More <i class="ph ph-arrow-right ms-1"></i></a>
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-6 col-lg-3 reveal" style="transition-delay:.1s">
        <div class="product-card">
          <div class="product-img-wrap">
            <img src="https://images.unsplash.com/photo-1558642891-54be180ea339?w=600&q=80&fit=crop" alt="Raw Honey" loading="lazy">
            <span class="product-badge badge-low">⚠ Low Stock</span>
          </div>
          <div class="product-body">
            <div class="product-name">Raw Honey</div>
            <div class="product-sub">Single-origin, cold-pressed harvest</div>
            <a href="#" class="btn-product">Learn More <i class="ph ph-arrow-right ms-1"></i></a>
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-6 col-lg-3 reveal" style="transition-delay:.15s">
        <div class="product-card">
          <div class="product-img-wrap">
            <img src="https://images.unsplash.com/photo-1611231787843-5a89e23c5dd1?w=600&q=80&fit=crop" alt="Beeswax" loading="lazy">
            <span class="product-badge badge-instock">✓ In Stock</span>
          </div>
          <div class="product-body">
            <div class="product-name">Beeswax</div>
            <div class="product-sub">Pure, natural wax from Filipino hives</div>
            <a href="#" class="btn-product">Learn More <i class="ph ph-arrow-right ms-1"></i></a>
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-6 col-lg-3 reveal" style="transition-delay:.2s">
        <div class="product-card">
          <div class="product-img-wrap">
            <img src="https://images.unsplash.com/photo-1472723740421-34c888f30a3b?w=600&q=80&fit=crop" alt="Propolis" loading="lazy">
            <span class="product-badge badge-soldout">✕ Sold Out</span>
          </div>
          <div class="product-body">
            <div class="product-name">Propolis</div>
            <div class="product-sub">Antimicrobial hive resin extract</div>
            <a href="#" class="btn-product">Notify Me <i class="ph ph-bell ms-1"></i></a>
          </div>
        </div>
      </div>

      <!-- Royal Jelly -->
      <div class="col-sm-6 col-lg-3 reveal" style="transition-delay:.25s">
        <div class="product-card">
          <div class="product-img-wrap">
            <img src="https://images.unsplash.com/photo-1587049352851-8d4e89133924?w=600&q=80&fit=crop" alt="Royal Jelly" loading="lazy">
            <span class="product-badge badge-low">⚠ Low Stock</span>
          </div>
          <div class="product-body">
            <div class="product-name">Royal Jelly</div>
            <div class="product-sub">Premium queen bee secretion</div>
            <a href="#" class="btn-product">Learn More <i class="ph ph-arrow-right ms-1"></i></a>
          </div>
        </div>
      </div>
      ...
      <!-- Bee Pollen -->
      <div class="col-sm-6 col-lg-3 reveal" style="transition-delay:.3s">
        <div class="product-card">
          <div class="product-img-wrap">
            <img src="https://images.unsplash.com/photo-1606914707987-29c74889f4c3?w=600&q=80&fit=crop" alt="Bee Pollen" loading="lazy">
            <span class="product-badge badge-instock">✓ In Stock</span>
          </div>
          <div class="product-body">
            <div class="product-name">Bee Pollen</div>
            <div class="product-sub">Protein-rich superfood granules</div>
            <a href="#" class="btn-product">Learn More <i class="ph ph-arrow-right ms-1"></i></a>
          </div>
        </div>
      </div>
      ...
      <!-- Honey Comb -->
      <div class="col-sm-6 col-lg-3 reveal" style="transition-delay:.35s">
        <div class="product-card">
          <div class="product-img-wrap">
            <img src="https://images.unsplash.com/photo-1601063476271-a159c71ab0b3?w=600&q=80&fit=crop" alt="Honeycomb" loading="lazy">
            <span class="product-badge badge-instock">✓ In Stock</span>
          </div>
          <div class="product-body">
            <div class="product-name">Honeycomb</div>
            <div class="product-sub">Cut comb, straight from the hive</div>
            <a href="#" class="btn-product">Learn More <i class="ph ph-arrow-right ms-1"></i></a>
          </div>
        </div>
      </div>
      ...
      <!-- Starter Colony -->
      <div class="col-sm-6 col-lg-3 reveal" style="transition-delay:.4s">
        <div class="product-card">
          <div class="product-img-wrap">
            <img src="https://images.unsplash.com/photo-1619451334792-150fd785ee74?w=600&q=80&fit=crop" alt="Starter Colony" loading="lazy">
            <span class="product-badge badge-low">⚠ Low Stock</span>
          </div>
          <div class="product-body">
            <div class="product-name">Starter Colony</div>
            <div class="product-sub">Nucleus colony for new beekeepers</div>
            <a href="#" class="btn-product">Learn More <i class="ph ph-arrow-right ms-1"></i></a>
          </div>
        </div>
      </div>
...
<section class="cta-section">
  <div class="container position-relative text-center">
    <div class="reveal">
      ...
      <h2 class="section-heading text-white fs-1 mt-3 mb-3">Ready to Manage Your Apiaries?</h2>
      <p class="text-white-50 mb-5 fs-5" style="max-width:500px;margin:0 auto 32px;">
        Join registered beekeepers using APIACORE to monitor, grow, and sustain their honey production.
      </p>
      <a href="<?php echo base_url('auth/login'); ?>" class="btn-cta">
        <i class="ph ph-sign-in"></i> Access the Dashboard
      </a>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="row g-5 mb-4">
      ...
      <div class="col-6 col-lg-2">
        ...
        <a href="<?php echo base_url('website/map'); ?>" class="footer-link">Apiaries Map</a>
        <a href="<?php echo base_url('website/news'); ?>" class="footer-link">News</a>
        <a href="<?php echo base_url('website/about'); ?>" class="footer-link">About</a>
      </div>
      <div class="col-6 col-lg-2">
        <div class="footer-heading">Products</div>
        <a href="#" class="footer-link">Wild Honey</a>
        <a href="#" class="footer-link">Raw Honey</a>
        <a href="#" class="footer-link">Beeswax</a>
        <a href="#" class="footer-link">Propolis</a>
        <a href="#" class="footer-link">Royal Jelly</a>
      </div>
      <div class="col-6 col-lg-2">
        <div class="footer-heading">Management</div>
        <a href="<?php echo base_url('auth/login'); ?>" class="footer-link">Dashboard</a>
        <a href="<?php echo base_url('colony/'); ?>" class="footer-link">Colonies</a>
        <a href="<?php echo base_url('beekeeper/'); ?>" class="footer-link">Beekeepers</a>
        <a href="<?php echo base_url('production/'); ?>" class="footer-link">Production</a>
      </div>
      <div class="col-6 col-lg-2">
