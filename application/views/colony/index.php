<div id="main">
  <div class="main-container">
    <div class="page-header-card">
      <div>
        <h4><i class="ph ph-cube me-2 text-primary"></i><?php echo $this->lang->line('Colonies'); ?></h4>
        <p>Manage all apiary colonies and current phases.</p>
      </div>
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0 small">
          <li class="breadcrumb-item"><a href="<?php echo base_url('dashboard') ?>" class="text-decoration-none">Home</a></li>
          <li class="breadcrumb-item active"><?php echo $this->lang->line('Colonies'); ?></li>
        </ol>
      </nav>
    </div>
      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="dt-card">
          <div class="dt-card-header">
            <h5 class="mb-0">All Colonies</h5>
            <?php if(in_array('createColony', $user_permission)): ?>
              <a href="<?php echo base_url('colony/create') ?>" class="btn-dt-add">
                <i class="ph ph-plus mb-1"></i> <?php echo $this->lang->line('Add Colony'); ?>
              </a>
            <?php endif; ?>
          </div>
    ...
    <div class="modal-content border-0 shadow rounded-4">
      <div class="modal-header border-bottom-0 pb-0 pt-4 px-4">
        <h4 class="modal-title fw-bold text-danger d-flex align-items-center">
          ...
          <?php echo $this->lang->line('Delete Colony'); ?>
        </h4>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>

      <form role="form" action="<?php echo base_url('colony/remove') ?>" method="post" id="removeForm">
        <div class="modal-body px-4 py-4">
          <p class="text-secondary mb-3"><?php echo $this->lang->line('All the information about the colony will be deleted.'); ?></p>
          <div class="alert alert-danger mb-3 border-0 bg-danger bg-opacity-10 text-danger rounded-3">
             <i class="ph ph-info me-1"></i> <?php echo $this->lang->line('It will not be possible to recover the colony, production and documents.'); ?>
          </div>
          <p class="text-secondary mb-4"><?php echo $this->lang->line('Change the activity of the colony (inactive) if you want to keep the information.'); ?></p>
...
$(document).ready(function() {
  ...
  manageTable = $('#manageTable').DataTable({
    'ajax': base_url + 'colony/fetchColonyData',
